<div class="container">
    <div>
        <p class="alert-warning">Sorry! The data for the targe month is already exist. If you want to change please update by clicking <i>UPDATE</i> button.</p>
        <h3 CLASS="text-center">INSERT THE DEDUCTED DAYS</h3>
    </div>
